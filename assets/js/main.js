...
(function () {
    ...
    function setStickyContainersSize() {
        document.querySelectorAll('.sticky-container').forEach(function (container) {
            const stikyContainerHeight = (container.querySelector('.horizontalScrollContainer').scrollWidth - window.innerHeight);
    ...
    function wheelHandler(evt) {
        ...
        if (g_canScrollHorizontally) {
            containerInViewPort.querySelector('.horizontalScrollContainer').scrollLeft += evt.deltaY;
        }
    }
})();
